...
weather_xml = urllib2.urlopen('http://graphical.weather.gov/xml/SOAP_server/ndfdSOAPclientByDay.php?whichClient=NDFDgenByDay&lat=30.58&lon=-96.37&format=24+hourly&numDays=4&Unit=e').read()
